...
for n in range(0, int(input())):
    ...
    if (a == b == c == 0):
        ans.append("0.000000 0.000000 0.000000")
    else:
        point = [a, b, c]
        axis = [x, y, z]
        r = vals[6]
        ...
        ans.append(str('{:.6f}'.format(round(undo_basis_change[0], 6))) + " " + str('{:.6f}'.format(round(undo_basis_change[1], 6)))
                   + " " + str('{:.6f}'.format(round(undo_basis_change[2], 6))))
